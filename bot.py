...
def solve_and_post():
    try:
        ...
        prompt = (
            "اكتب منشور فيسبوك قصير ومؤثر عن فضل العشر الأواخر من رمضان. "
            "أضف في نهاية المنشور 3 هاشتاجات قوية ومناسبة. "
            "أضف عبارة دعوة للتفاعل تكون محفزة ولا تخالف سياسة فيسبوك. "
            "وفي السطر الأخير اكتب كلمة 'Keywords:' متبوعة بـ 3 كلمات إنجليزية فقط للبحث عن صورة."
        )
